...
// update cow service
const updateCowService = (id, updatedData, user) => __awaiter(void 0, void 0, void 0, function* () {
    const { _id } = user;
    const cow = yield cow_model_1.Cow.findOne({ _id: id, seller: _id });
    if (!cow) {
...
// delete cow service
const deleteCowService = (id, user) => __awaiter(void 0, void 0, void 0, function* () {
    const { _id } = user;
    const cow = yield cow_model_1.Cow.findOne({ _id: id, seller: _id });
    if (!cow) {
        throw new ApiError_1.default(http_status_1.default.UNAUTHORIZED, "Can't delete the cow because this is not your cow.");
    }
